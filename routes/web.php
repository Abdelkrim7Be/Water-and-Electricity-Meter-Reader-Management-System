...
Route::post('/app/admin_login', [AdminController::class, 'adminLogin'])->middleware('throttle:login');
Route::post('/logout', [AdminController::class, 'logout']);
Route::get('/uploads/{filename}', [AdminController::class, 'image'])->middleware(AdminCheck::class);
...
Route::prefix('/app')->middleware([App\Http\Middleware\AdminCheck::class])->group(function () {
    ...
    Route::get('/releveur_options', [AdminController::class, 'releveurOptions']);
