                    ...
                    <div class="_overflow _table_div">
                        <table class="_table">
                            ...
                            <tr>
                                ...
                                <th>tournee_debut</th>
                                <th>tournee_fin</th>
                                <th style="min-width: 130px">Ordre_paquets</th>
                                <th>Paquets</th>
                                <th>Compteurs</th>
                                <th>Durée</th>
                                <th>Crée le</th>
                        ...
                        <Select
                            v-model="selectedReleveur"
                            style="
                                width: 200px;
                                /* margin-bottom: 5px !important; */
                            "
                            placeholder="Releveurs"
                            @on-change="changeReleveur"
                        >
    ...
    methods: {
        ...
        async getPlanData(page = 1) {
            ...
            if (res.status == 200 && res2.status == 200) {
                this.relevePlans = res.data.data;
                this.plans = this.relevePlans;
        ...
        async addPlan() {
            if (
                ...
                this.e("All fields are  required!");
                return;
            }
            const res = await this.callApi(
                "post",
            ...
            if (res.status == 201) {
                ...
                this.s("planning added successfully");
                this.getPlanData();
                this.addModal = false;
                this.data.releveur = "";
                this.data.date_releve = "";
        ...
        async editPlan() {
            ...
            if (res.status == 200) {
                ...
                this.s("planning has been edited successfully");
                this.editModal = false;
            } else {
                if (res.status == 422) {
                    let missingFields = [];
        ...
        changeReleveur() {
            if (this.selectedReleveur !== "All") {
                this.plans = this.plans.filter(
                    (plan) => plan.releveur === this.selectedReleveur
                );
            }
        },
    },
